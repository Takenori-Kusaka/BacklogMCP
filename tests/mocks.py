...
class MockBacklogClient:
    ...
    def create_issue(self, **kwargs):
        ...
        # 課題種別名から課題種別IDを解決
        if kwargs.get("issue_type_id") is None and kwargs.get("issue_type_name") is not None:
        ...
        # 優先度名から優先度IDを解決
        if kwargs.get("priority_id") is None and kwargs.get("priority_name") is not None:
            kwargs["priority_id"] = self.get_priority_id_by_name(kwargs.get("priority_name"))
        
        # 担当者名から担当者IDを解決
        if kwargs.get("assignee_id") is None and kwargs.get("assignee_name") is not None:
            kwargs["assignee_id"] = self.get_user_id_by_name(kwargs.get("assignee_name"))
        
        return {
            "id": 1, "issueKey": "TEST-1", "summary": kwargs.get("summary", "新しい課題")
        }
    ...
    def update_issue(self, issue_id_or_key, **kwargs):
        ...
        if kwargs.get("status_id") is None and kwargs.get("status_name") is not None:
            kwargs["status_id"] = self.get_status_id_by_name(1, kwargs.get("status_name"))
        ...
        return {
            "id": 1, "issueKey": "TEST-1", "summary": kwargs.get("summary", "更新された課題")
        }
...
class MockIssueService:
    ...
    def get_issues(self, project_id=None, status_id=None, assignee_id=None, keyword=None, count=20):
        """
        課題一覧を取得
    ...
    def create_issue(self, project_id=None, project_key=None, summary=None, 
                    issue_type_id=None, issue_type_name=None,
    ...
    def update_issue(self, issue_id_or_key, summary=None, description=None, 
