...
class TestBulkOperationsService:
    ...
    def test_bulk_update_status_returns_success_count(
        self, mock_backlog_client: Mock
    ) -> None:
        ...
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-1", status_id=2
        )
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-2", status_id=2
        )
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-3", status_id=2
        )
    ...
    def test_bulk_update_assignee_returns_success_count(
        self, mock_backlog_client: Mock
    ) -> None:
        ...
        result = bulk_service.bulk_update_assignee(
            issue_ids=["TEST-1", "TEST-2"], assignee_id=123
        )

        # モックが正しいパラメータで呼ばれたことを確認
        assert mock_backlog_client.update_issue.call_count == 2
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-1", assignee_id=123
        )
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-2", assignee_id=123
        )
    ...
    def test_bulk_update_priority_returns_success_count(
        self, mock_backlog_client: Mock
    ) -> None:
        ...
        result = bulk_service.bulk_update_priority(
            issue_ids=["TEST-1", "TEST-2"], priority_id=3
        )

        # モックが正しいパラメータで呼ばれたことを確認
        assert mock_backlog_client.update_issue.call_count == 2
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-1", priority_id=3
        )
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-2", priority_id=3
        )
    ...
    def test_bulk_update_milestone_returns_success_count(
        self, mock_backlog_client: Mock
    ) -> None:
        ...
        result = bulk_service.bulk_update_milestone(
            issue_ids=["TEST-1", "TEST-2"], milestone_id=5
        )

        # モックが正しいパラメータで呼ばれたことを確認
        assert mock_backlog_client.update_issue.call_count == 2
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-1", milestone_id=[5]
        )
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-2", milestone_id=[5]
        )
    ...
    def test_bulk_update_category_returns_success_count(
        self, mock_backlog_client: Mock
    ) -> None:
        ...
        result = bulk_service.bulk_update_category(
            issue_ids=["TEST-1", "TEST-2"], category_id=10
        )

        # モックが正しいパラメータで呼ばれたことを確認
        assert mock_backlog_client.update_issue.call_count == 2
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-1", category_id=[10]
        )
        mock_backlog_client.update_issue.assert_any_call(
            issue_id_or_key="TEST-2", category_id=[10]
        )
    ...
    def test_bulk_delete_issues_returns_success_count(
        self, mock_backlog_client: Mock
    ) -> None:
