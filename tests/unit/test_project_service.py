...
class TestProjectService:
    ...
    def test_get_project_returns_dict(self, mock_backlog_client: Mock) -> None:
    ...
    def test_get_project_handles_not_found(self, mock_backlog_client: Mock) -> None:
    ...
    def test_get_project_handles_error(self, mock_backlog_client: Mock) -> None:
        """エラー発生時の処理をテスト"""
        # モックがエラーを発生させるように設定
    ...
    def test_get_projects_handles_empty_response(
    ...
    def test_get_projects_handles_error(self, mock_backlog_client: Mock) -> None:
        """エラー発生時の処理をテスト"""
        # モックがエラーを発生させるように設定
