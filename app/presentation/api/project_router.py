...
@router.get("/{project_key}/statuses", response_model=List[Dict[str, Any]], operation_id="get_project_statuses")
...
@router.get("/{project_key}/issue-types", response_model=List[Dict[str, Any]], operation_id="get_project_issue_types")
...
@router.get("/{project_key}/categories", response_model=List[Dict[str, Any]], operation_id="get_project_categories")
...
@router.get("/{project_key}/milestones", response_model=List[Dict[str, Any]], operation_id="get_project_milestones")
...
@router.get("/{project_key}/versions", response_model=List[Dict[str, Any]], operation_id="get_project_versions")
