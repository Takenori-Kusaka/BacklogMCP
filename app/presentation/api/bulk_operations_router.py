...
@router.post("/status", response_model=Dict[str, Any], operation_id="bulk_update_status")
...
@router.post("/assignee", response_model=Dict[str, Any], operation_id="bulk_update_assignee")
async def bulk_update_assignee(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to bulk update assignee: {str(e)}"
        )


@router.post("/priority", response_model=Dict[str, Any], operation_id="bulk_update_priority")
async def bulk_update_priority(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to bulk update priority: {str(e)}"
        )


@router.post("/milestone", response_model=Dict[str, Any], operation_id="bulk_update_milestone")
async def bulk_update_milestone(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to bulk update milestone: {str(e)}"
        )


@router.post("/category", response_model=Dict[str, Any], operation_id="bulk_update_category")
async def bulk_update_category(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to bulk update category: {str(e)}"
        )


@router.post("/delete", response_model=Dict[str, Any], operation_id="bulk_delete_issues")
async def bulk_delete_issues(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Failed to bulk delete issues: {str(e)}"
        )
