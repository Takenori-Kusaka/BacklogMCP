...
class BulkOperationsService:
    ...
    def bulk_update_status(self, issue_ids: List[str], status_id: int) -> Dict[str, Any]:
        """
        複数チケットのステータスを一括更新
    ...
    def bulk_update_assignee(self, issue_ids: List[str], assignee_id: int) -> Dict[str, Any]:
        """
        複数チケットの担当者を一括更新
    ...
    def bulk_update_priority(self, issue_ids: List[str], priority_id: int) -> Dict[str, Any]:
        """
        複数チケットの優先度を一括更新
    ...
    def bulk_update_milestone(self, issue_ids: List[str], milestone_id: int) -> Dict[str, Any]:
        """
        複数チケットのマイルストーンを一括更新
    ...
    def bulk_update_category(self, issue_ids: List[str], category_id: int) -> Dict[str, Any]:
        """
        複数チケットのカテゴリを一括更新
